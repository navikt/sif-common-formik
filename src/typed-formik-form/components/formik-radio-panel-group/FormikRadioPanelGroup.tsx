...
import { RadioPanelGruppe, RadioPanelGruppeProps, RadioPanelProps } from 'nav-frontend-skjema';
...
interface OwnProps<FieldName> extends Omit<RadioPanelGruppeProps, 'radios' | 'name' | 'onChange'> {
    name: FieldName;
